...
**Pourquoi l'escorte n'est pas le danger qu'on croit.** La fauchée balaie un secteur de 120° sur 3 blocs, et les six Costauds massés y tiennent ensemble : deux secondes d'épée pour les six — depuis que la poussée les empêche d'occuper le même point, ils tiennent la place que leur rassemblement leur donne, et il faut être placé pour les prendre tous d'un coup ; c'est au banc de dire ce que cela coûte vraiment. Leur vrai coût est en points de vie du joueur, par contact (chapitre 4), et en boulets détournés — les canons qui tirent sur le Colosse les touchent aussi, et il faut choisir.
